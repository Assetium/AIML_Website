...
const page = () => {
  const accordionItems = [
    {
      ...
      content: (
        <p className=" text-xs leading-[1.8]">
          Agrivest is a structured investment portfolio designed to help
          investors achieve short-term financial goals while ensuring liquidity,
          capital preservation, and competitive returns. Managed by a team of
          experts, the portfolio allows individuals to invest in physical
          commodities, providing a secure and alternative investment option.
          Profits on the portfolio are compounded either quarterly,
          semiannually, or at maturity, allowing investors to maximize their
          earnings over time. It is tailored for retail investors and
          medium-class net-worth individuals looking for a smart and stable way
          to grow their wealth through commodity-backed investments. With
          Agrivest, investors can confidently diversify their assets and enjoy
          the benefits of a well-managed and secure investment opportunity.
        </p>
      ),
    },
    {
      ...
      content: (
        <ul className="text-gray-500 pr-7 text-justify pl-5 list-disc">
          ...
          <li className=" text-xs leading-[1.8] py-2">
            <strong> Customization: </strong> Tailored portfolio options
            available to meet specific client investment goals and risk
            tolerance.
          </li>
        </ul>
      ),
    ...
    },
    {
      ...
      content: (
        <>
          <p className="text-gray-500 text-sm">The portfolio is targeted at:</p>
          <ul className="text-gray-500 pr-7 text-justify pl-5 list-disc">
            <li className=" text-xs leading-[1.8] py-2">
              <strong>Institutional Investors: </strong>
              Including hedge funds, pension funds, and insurance companies
              looking for diversification and inflation protection.
            </li>
            <li className=" text-xs leading-[1.8] py-2">
  ...
  const portfolios = [
    {
      image: agrivest,
      // image: halal,
      title: "Assetium Halal Commodities Portfolio (AHCP)",
      amount: "₦50,000",
  ...
  const otherPortfolios = portfolios.filter(
    (portfolio) => portfolio.title !== "Agrivest  ",
  );
